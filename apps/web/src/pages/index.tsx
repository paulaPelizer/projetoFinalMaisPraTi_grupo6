...
import { BarChart3, FileText, FolderKanban, Users, Briefcase, ArrowRightLeft } from "lucide-react"
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                  Gerencie projetos, documentos técnicos e tramitações entre clientes e fornecedores de forma eficiente.
                </p>
              </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="neon-border">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Cadastre e gerencie projetos com suas respectivas listas de documentos.
                  </p>
                </CardContent>
              </Card>
              <Card className="neon-border">
              ...
              <Card className="neon-border">
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Gerencie solicitações de tramitação de documentos.</p>
                </CardContent>
              </Card>
              <Card className="neon-border">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
